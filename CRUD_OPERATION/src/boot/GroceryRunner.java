...
import app.repository.ArtistRepositoryImpl;
import app.repository.GroceryRepository;
import app.repository.GroceryRepositoryImpl;
import app.repository.HistoricalPlacesRepository;
import app.repository.HistoricalPlacesRepositoryImpl;
import app.repository.JacketRepository;
import app.repository.JacketRepositoryImpl;
import app.repository.MedicineRepository;
import app.repository.MedicineRepositoryImpl;
import app.repository.PatientRepository;
import app.repository.PatientRepositoryImpl;
import app.repository.PilotRepository;
import app.repository.PilotRepositoryImpl;
import app.repository.PoliticianRepository;
import app.repository.PoliticianRepositoryImpl;
